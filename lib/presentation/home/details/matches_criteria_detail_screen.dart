...
class _MatchesCriteriaDetailState extends State<MatchesCriteriaDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    List<String> allCourtTypes = ETypeCourt.GetAllTypes();
    List<String> allCourTypesPicker = [];
    List<int> A = [];
            ...
            children: [
              Container(
                ...
                child: ClipRRect(
                  ...
                  child:itemDetail.team!.urlImage != null ? Image.network(itemDetail.team!.urlImage!,
                      fit: BoxFit.fill): Image.asset(AppImages.userEmpty),
                ),
              ),
              Container(
                ...
                child: SingleChildScrollView(
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        _itemDetail("Tên đội bóng", itemDetail.team!.name),
                        _itemDetail("Kĩ năng",
                            itemDetail.skillLevelList!.join(",").toLowerCase()),
                        _itemDetail(
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            onChanged: (String? newValue) {
                              setState(() {
                                ...
                                matchesCriteriaDetailController.selectedCourtType.value = _selectedCourtType!;
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            onChanged: (String? newValue) {
                              setState(() {
                                ...
                                matchesCriteriaDetailController.selectedSkillLevel.value = _selectedSkillLevel!;
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            onChanged: (String? newValue) {
                              setState(() {
                                ...
                                matchesCriteriaDetailController.selectedTimeMatch.value = _selectedTimeMatch!;
                        ...
                        Container(
                          child: DropdownButtonFormField<String>(
                            ...
                            onChanged: (String? newValue) {
                              setState(() {
                                _selectedRole = newValue;
                                matchesCriteriaDetailController.selectedAddress.value
                                 =_selectedRole!;
                              });
                            },
                            items: matchesCriteriaDetailController.getAddressesAsList(itemDetail.addressList!)
                                .map<DropdownMenuItem<String>>(
                                    (String role) {
                                  return DropdownMenuItem<String>(
                                    value: role,
                            ...
                            onPressed: () {
                              ...
                              matchesCriteriaDetailController.createMatches(
                                MatchModel(
                                    ...
                                    status: "SCHEDULED",
                                    typeCourt: matchesCriteriaDetailController.selectedCourtType.value,
                                    skillLevel: matchesCriteriaDetailController.selectedSkillLevel.value,
                                    address:  matchesCriteriaDetailController.selectedAddress.value,
