...
abstract class CustomHttpClient {
  ...
  /// Variable [isHaveGetCharacter] Most GET APIs do not have a `\get`
  ...
  Future<dynamic> get(
      String url, {
        ...
        bool isV2 = false,
        bool isDisplayErrorDialog = true,
        bool isHaveGetCharacter = false,
      });
    ...
    try {
      final response = await _dio.get(
        ...
        options: Options(headers: headers, extra: {
          // AppConstants.isV2Option: isV2,
          // AppConstants.isDisplayDialogError: isDisplayErrorDialog,
        }),
      );
